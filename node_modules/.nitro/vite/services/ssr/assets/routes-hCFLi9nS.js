...
import { AlertTriangle, ArrowRight, BrainCircuit, CheckCircle2, Cog, Cpu, Droplets, Factory, Flame, Gauge, Info, Layers, Leaf, Package, Pause, Play, RotateCcw, ShieldCheck, Snowflake, Sparkles, Thermometer, Waves, Weight } from "lucide-react";
import { clsx } from "clsx";
import { twMerge } from "tailwind-merge";
import { Area, AreaChart, Bar, BarChart, CartesianGrid, Cell, Line, LineChart, ResponsiveContainer, Tooltip, XAxis, YAxis } from "recharts";
//#region src/lib/ecopellet.ts
var STAGES = [
	{
		id: "input",
...
//#endregion
//#region src/components/eco/ProcessLine.tsx
var ICONS = [
	Leaf,
	Flame,
	Cog,
			...
			children: [
				/* @__PURE__ */ jsxs("header", {
					...
					children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: cn("size-1.5 rounded-full", running ? "bg-primary" : "bg-muted-foreground") }), running ? "Running" : started ? "Standby" : "Idle"]
					})]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						running && Array.from({ length: 9 }).map((_, i) => /* @__PURE__ */ jsx(Leaf, {
							...
							children: [
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [/* @__PURE__ */ jsx("span", {
										...
										children: done ? /* @__PURE__ */ jsx(CheckCircle2, { className: "size-4" }) : /* @__PURE__ */ jsx(Icon, { className: "size-4" })
									}), /* @__PURE__ */ jsxs("div", {
										className: "min-w-0",
...
//#endregion
//#region src/components/eco/SbpaDashboard.tsx
		...
		children: [
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("span", {
					...
					children: [/* @__PURE__ */ jsx(Icon, { className: cn("size-3.5", color) }), label]
				}), /* @__PURE__ */ jsx("span", { className: cn("size-1.5 rounded-full bg-current", color) })]
			}),
			/* @__PURE__ */ jsxs("p", {
		...
		children: [
			/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h2", {
					...
					children: [/* @__PURE__ */ jsx(Info, { className: "size-3" }), " Simulated data"]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
									...
									children: /* @__PURE__ */ jsxs(BarChart, {
										...
										children: [
											...
											/* @__PURE__ */ jsx(Bar, {
												...
												radius: 3,
												barSize: 9,
												children: analysis.breakdown.map((b) => /* @__PURE__ */ jsx(Cell, { fill: b.value >= 75 ? "var(--chart-1)" : b.value >= 50 ? "var(--chart-3)" : "var(--chart-4)" }, b.label))
											})
										]
									})
								})
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("p", {
							...
							children: [
								/* @__PURE__ */ jsx(BrainCircuit, { className: "size-3.5 text-accent" }),
								" AI Insight",
								/* @__PURE__ */ jsx("span", {
					...
					children: [/* @__PURE__ */ jsx("p", {
						...
						children: analysis.alerts.map((a, i) => {
							...
							return /* @__PURE__ */ jsxs("li", {
								...
								children: [/* @__PURE__ */ jsx(Icon, { className: "mt-0.5 size-4 shrink-0" }), /* @__PURE__ */ jsx("span", {
...
//#endregion
//#region src/hooks/useEcoPellet.ts
var TICK_MS = 120;
var SPEED = 1;
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsxs("header", {
					...
					children: [
						...
						/* @__PURE__ */ jsx("ol", {
							...
							children: FLOW.map((f, i) => /* @__PURE__ */ jsxs("li", {
								...
								children: [/* @__PURE__ */ jsxs("span", {
									...
									children: [/* @__PURE__ */ jsx(f.icon, { className: "size-3.5" }), f.label]
								}), i < FLOW.length - 1 && /* @__PURE__ */ jsx(ArrowRight, { className: "size-3.5 text-muted-foreground" })]
							}, f.label))
						}),
						/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						/* @__PURE__ */ jsxs("button", {
							...
							children: [/* @__PURE__ */ jsx(Play, { className: "size-4" }), " Start Process"]
						}),
						/* @__PURE__ */ jsxs("button", {
							onClick: sim.pause,
							...
							children: [/* @__PURE__ */ jsx(Pause, { className: "size-4" }), " Pause"]
						}),
						/* @__PURE__ */ jsxs("button", {
							onClick: sim.reset,
						...
						/* @__PURE__ */ jsx("span", { className: "mx-2 hidden h-6 w-px bg-border sm:block" }),
						/* @__PURE__ */ jsx("span", {
							className: "font-mono text-[10px] uppercase tracking-[0.16em] text-muted-foreground",
							children: "Scenario"
						}),
						["optimal", "high-moisture"].map((id) => /* @__PURE__ */ jsx("button", {
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(ProcessLine, {
						stageIndex: sim.stageIndex,
						elapsed: sim.elapsed,
						running: sim.running,
						readings: sim.readings,
						started: sim.started
					}), /* @__PURE__ */ jsx(SbpaDashboard, {
						readings: sim.readings,
